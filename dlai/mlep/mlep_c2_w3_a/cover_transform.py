...
def preprocessing_fn(inputs):
    ...
    for feature in _SCALE_MINMAX_FEATURE_KEYS:
        ...
        features_dict[_transformed_name(feature)] = tft.scale_by_min_max(
            inputs[feature])
    ...
    for feature in _SCALE_Z_FEATURE_KEYS:
        ...
        features_dict[_transformed_name(feature)] = tft.scale_to_z_score(
            inputs[feature])
    ...
    for feature in _HASH_STRING_FEATURE_KEYS:
        ...
        features_dict[_transformed_name(feature)] = tft.hash_strings(
            inputs[feature], hash_buckets=10)
